...
# this is the GUI controller tab of the notebook widget in the main window. It
# manages everything (settings) of the GUI controller.
##########
# By B.Gao Dec. 2018
...
from adv_conf_ctl import adv_conf_ctl


class ctl:
    def __init__(self, parent):
        # the advanced settings
        self.adv_conf = adv_conf_ctl()
