...
# this is the logger tab of the notebook widget in the main window. It
# manages everything (settings) of the logger.
##########
# By B.Gao Jan. 2019
...
from adv_conf_log import adv_conf_log


class log:
    def __init__(self, parent):
        # the advanced settings
        self.adv_conf = adv_conf_log()
