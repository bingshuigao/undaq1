...
# this is the event builder tab of the notebook widget in the main window. It
# manages everything (settings) of the event builder.
##########
# By B.Gao Nov. 2018
...
from adv_conf_ebd import adv_conf_ebd


class ebd:
    def __init__(self, parent):
        # the advanced settings
        self.adv_conf = adv_conf_ebd()
